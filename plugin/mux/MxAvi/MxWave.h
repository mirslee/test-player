#ifndef __MX_WAVE_H__
#define __MX_WAVE_H__
...
#ifndef _MX_BITMAPINFOHEADER_
#define _MX_BITMAPINFOHEADER_
...
} MX_BITMAPINFOHEADER, *MX_PBITMAPINFOHEADER, *MX_LPBITMAPINFOHEADER;

typedef struct
ATTR_PACKED
{
    MX_BITMAPINFOHEADER bmiHeader;
    int                  bmiColors[1];
} MX_BITMAPINFO, *MX_LPBITMAPINFO;
#endif
...
/* GUID SubFormat IDs */
#define MX_KSDATAFORMAT_SUBTYPE_ATRAC3P {0xE923AABF, 0xCB58, 0x4471, {0xA1, 0x19, 0xFF, 0xFA, 0x01, 0xE4, 0xCE, 0x62}} /* Undocumented */
#define MX_KSDATAFORMAT_SUBTYPE_UNKNOWN {0x00000000, 0x0000, 0x0000, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}}
#define MX_WAVEFORMATEX_GUIDBASE        {0x00000000, 0x0000, 0x0010, {0x80, 0x00, 0x00, 0xaa, 0x00, 0x38, 0x9b, 0x71}} /* Generated from Wave Format */
#define MX_AMBISONIC_SUBTYPE_PCM        {0x00000001, 0x0721, 0x11D3, {0x86, 0x44, 0xC8, 0xC1, 0xCA, 0x00, 0x00, 0x00}} /* AMBISONIC_B_FORMAT_PCM */
#define MX_AMBISONIC_SUBTYPE_IEEE_FLOAT {0x00000003, 0x0721, 0x11D3, {0x86, 0x44, 0xC8, 0xC1, 0xCA, 0x00, 0x00, 0x00}} /* AMBISONIC_B_FORMAT_IEEE_FLOAT */
...
{
    { WAVE_FORMAT_PCM,              MX_FOURCC( 'a', 'r', 'a', 'w' ), "Raw audio" },
    { WAVE_FORMAT_PCM,              MX_CODEC_S8,                     "PCM S8 audio" },
    { WAVE_FORMAT_PCM,              MX_CODEC_S16L,                   "PCM S16L audio" },
    { WAVE_FORMAT_PCM,              MX_CODEC_S24L,                   "PCM S24L audio" },
    { WAVE_FORMAT_PCM,              MX_CODEC_S32L,                   "PCM S32L audio" },
    { WAVE_FORMAT_ADPCM,            MX_CODEC_ADPCM_MS,               "ADPCM" },
    { WAVE_FORMAT_IEEE_FLOAT,       MX_FOURCC( 'a', 'f', 'l', 't' ), "IEEE Float audio" },
    { WAVE_FORMAT_IEEE_FLOAT,       MX_CODEC_F32L,                   "PCM 32 (Float) audio" },
    { WAVE_FORMAT_IEEE_FLOAT,       MX_CODEC_F64L,                   "PCM 64 (Float) audio" },
    { WAVE_FORMAT_ALAW,             MX_CODEC_ALAW,                   "A-Law" },
    { WAVE_FORMAT_MULAW,            MX_CODEC_MULAW,                  "Mu-Law" },
    { WAVE_FORMAT_IMA_ADPCM,        MX_CODEC_ADPCM_IMA_WAV,          "Ima-ADPCM" },
    { WAVE_FORMAT_CREATIVE_ADPCM,   MX_CODEC_ADPCM_CREATIVE,         "Creative ADPCM" },
    { WAVE_FORMAT_YAMAHA_ADPCM,     MX_CODEC_ADPCM_YAMAHA,           "Yamaha ADPCM" },
    { WAVE_FORMAT_TRUESPEECH,       MX_CODEC_TRUESPEECH,             "Truespeech" },
    { WAVE_FORMAT_GSM610,           MX_CODEC_GSM_MS,                 "Microsoft WAV GSM" },
    { WAVE_FORMAT_MSNAUDIO,         MX_CODEC_GSM_MS,                 "Microsoft MSN Audio" },
    { WAVE_FORMAT_G726,             MX_CODEC_ADPCM_G726,             "G.726 ADPCM" },
    { WAVE_FORMAT_G726_ADPCM,       MX_CODEC_ADPCM_G726,             "G.726 ADPCM" },
    { WAVE_FORMAT_G723_1,           MX_CODEC_G723_1,                 "G.723.1" },
    { WAVE_FORMAT_MSG723,           MX_CODEC_G723_1,                 "Microsoft G.723 [G723.1]" },
    { WAVE_FORMAT_VIVOG723,         MX_CODEC_G723_1,                 "Vivo G.723.1" },
    { WAVE_FORMAT_MPEGLAYER3,       MX_CODEC_MP3,                    "Mpeg Audio Layer 3" },
    { WAVE_FORMAT_MPEG,             MX_CODEC_MPGA,                   "Mpeg Audio" },
    { WAVE_FORMAT_AMR_NB,           MX_CODEC_AMR_NB,                 "AMR NB" },
    { WAVE_FORMAT_AMR_NB_2,         MX_CODEC_AMR_NB,                 "AMR NB" },
    { WAVE_FORMAT_AMR_WB,           MX_CODEC_AMR_WB,                 "AMR Wideband" },
    { WAVE_FORMAT_SIPRO,            MX_CODEC_SIPR,                   "Sipr Audio" },
    { WAVE_FORMAT_A52,              MX_CODEC_A52,                    "A/52" },
    { WAVE_FORMAT_WMA1,             MX_CODEC_WMA1,                   "Window Media Audio v1" },
    { WAVE_FORMAT_WMA2,             MX_CODEC_WMA2,                   "Window Media Audio v2" },
    { WAVE_FORMAT_WMAP,             MX_CODEC_WMAP,                   "Window Media Audio 9 Professional" },
    { WAVE_FORMAT_WMAL,             MX_CODEC_WMAL,                   "Window Media Audio 9 Lossless" },
    { WAVE_FORMAT_WMAS,             MX_CODEC_WMAS,                   "Window Media Audio 9 Speech" },
    { WAVE_FORMAT_ATRAC3,           MX_CODEC_ATRAC3,                 "Sony Atrac3" },
    { WAVE_FORMAT_SONY_ATRAC3,      MX_CODEC_ATRAC3,                 "Sony Atrac3" },
    { WAVE_FORMAT_DK3,              MX_CODEC_ADPCM_DK3,              "Duck DK3" },
    { WAVE_FORMAT_DK4,              MX_CODEC_ADPCM_DK4,              "Duck DK4" },
    { WAVE_FORMAT_DTS,              MX_CODEC_DTS,                    "DTS Coherent Acoustics" },
    { WAVE_FORMAT_DTS_MS,           MX_CODEC_DTS,                    "DTS Coherent Acoustics" },
    { WAVE_FORMAT_DIVIO_AAC,        MX_CODEC_MP4A,                   "MPEG-4 Audio (Divio)" },
    { WAVE_FORMAT_AAC,              MX_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_QNAP_ADTS,        MX_CODEC_MP4A,                   "MPEG-4 ADTS Audio" },
    { WAVE_FORMAT_AAC_ADTS,         MX_CODEC_MP4A,                   "MPEG-4 ADTS Audio" },
    { WAVE_FORMAT_AAC_2,            MX_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AAC_3,            MX_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AAC_LATM,         MX_CODEC_MP4A,                   "MPEG-4 LATM Audio" },
    { WAVE_FORMAT_HEAAC,            MX_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AVCODEC_AAC,      MX_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_AAC_MS,           MX_CODEC_MP4A,                   "MPEG-4 Audio" },
    { WAVE_FORMAT_VORBIS,           MX_CODEC_VORBIS,                 "Vorbis Audio" },
    { WAVE_FORMAT_VORB_1,           MX_FOURCC( 'v', 'o', 'r', '1' ), "Vorbis 1 Audio" },
    { WAVE_FORMAT_VORB_1PLUS,       MX_FOURCC( 'v', 'o', '1', '+' ), "Vorbis 1+ Audio" },
    { WAVE_FORMAT_VORB_2,           MX_FOURCC( 'v', 'o', 'r', '2' ), "Vorbis 2 Audio" },
    { WAVE_FORMAT_VORB_2PLUS,       MX_FOURCC( 'v', 'o', '2', '+' ), "Vorbis 2+ Audio" },
    { WAVE_FORMAT_VORB_3,           MX_FOURCC( 'v', 'o', 'r', '3' ), "Vorbis 3 Audio" },
    { WAVE_FORMAT_VORB_3PLUS,       MX_FOURCC( 'v', 'o', '3', '+' ), "Vorbis 3+ Audio" },
    { WAVE_FORMAT_SPEEX,            MX_CODEC_SPEEX,                  "Speex Audio" },
    { WAVE_FORMAT_FLAC,             MX_CODEC_FLAC,                   "FLAC Audio" },
    { WAVE_FORMAT_GSM_AMR_FIXED,    MX_CODEC_AMR_NB,                 "GSM-AMR Audio CBR, no SID" },
    { WAVE_FORMAT_GSM_AMR,          MX_CODEC_AMR_NB,                 "GSM-AMR Audio VBR, SID" },
    { WAVE_FORMAT_ULEAD_DV_AUDIO_NTSC, MX_CODEC_ULEAD_DV_AUDIO_NTSC, "Ulead DV audio NTSC" },
    { WAVE_FORMAT_ULEAD_DV_AUDIO_PAL, MX_CODEC_ULEAD_DV_AUDIO_PAL,   "Ulead DV audio PAL" },
    { WAVE_FORMAT_IMC,              MX_CODEC_IMC,                    "IMC" },
    { WAVE_FORMAT_INDEO_AUDIO,      MX_CODEC_INDEO_AUDIO,            "Indeo Audio Coder" },
    { WAVE_FORMAT_VOXWARE_RT29,     MX_CODEC_METASOUND,              "VoxWare MetaSound" },
    { WAVE_FORMAT_ON2_AVC,          MX_CODEC_ON2AVC,                 "On2 Audio for Video Codec (VP7)" },
    { WAVE_FORMAT_ON2_AVC_2,        MX_CODEC_ON2AVC,                 "On2 Audio for Video Codec (VP6)" },

    { WAVE_FORMAT_UNKNOWN,          MX_CODEC_UNKNOWN,                "Unknown" }
};

static inline void wf_tag_to_fourcc( uint16_t i_tag, MxFourcc *fcc,
...
static inline void fourcc_to_wf_tag( MxFourcc fcc, uint16_t *pi_tag )
{
    int i;
    for( i = 0; wave_format_tag_to_fourcc[i].i_tag != 0; i++ )
    {
...
{
    const GUID   guid_tag;
    const MxFourcc i_fourcc;
    const char  *psz_name;
}
sub_format_tag_to_fourcc[] =
{
    { MX_AMBISONIC_SUBTYPE_PCM,        MX_FOURCC( 'a', 'r', 'a', 'w' ), "Ambisonic B format (PCM)" },
    { MX_AMBISONIC_SUBTYPE_IEEE_FLOAT, MX_FOURCC( 'a', 'f', 'l', 't' ), "Ambisonic B format (IEEE float)" },
    { MX_KSDATAFORMAT_SUBTYPE_ATRAC3P, MX_CODEC_ATRAC3P,                "Sony Atrac3+" },
    { MX_KSDATAFORMAT_SUBTYPE_UNKNOWN, MX_CODEC_UNKNOWN,      "Unknown" }
};
...
static inline void sf_tag_to_fourcc( const GUID *guid_tag,
                                     MxFourcc *fcc, const char **ppsz_name )
{
    int i;
    bool b_found = false;

    const GUID unknown = MX_KSDATAFORMAT_SUBTYPE_UNKNOWN;
    const GUID waveformatex = MX_WAVEFORMATEX_GUIDBASE;
