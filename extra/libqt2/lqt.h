 ...
 *
 *  Returned pointer should remain valid as int as the file is open.
 *  Do not free it.
 *
 *  Since 1.1.0
 */
 ...
 *  \param compressor Codec to use (see \ref codec_registry )
 *
...
int lqt_add_video_track(quicktime_t *file,
                        ...
                        int frame_duration, int timescale,char * compressor);
