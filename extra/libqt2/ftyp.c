...
static uint32_t ftyp_qt_brands[] = { MK_FOURCC('q','t',' ',' '),0,0,0 };
...
static uint32_t ftyp_mp4_brands[] = {MK_FOURCC('m','p','4','2'),
									 MK_FOURCC('i','s','o','m')};
...
static uint32_t ftyp_3gp_brands[] = { MK_FOURCC('i','s','o','m'),
									  MK_FOURCC('3','g','p','5'),
									  MK_FOURCC('3','g','p','4'),
									  MK_FOURCC('m','p','4','1'),
									  MK_FOURCC('m','p','4','2')};
...
static uint32_t ftyp_mp4a_brands[] = {MK_FOURCC('M','4','A',' '),
									  MK_FOURCC('m','p','4','2'),
									  MK_FOURCC('i','s','o','m'),
									  0};
...
static void copy_ftyp(quicktime_ftyp_t * dst, quicktime_ftyp_t * src)
  ...
  dst->compatible_brands = (uint32_t*)malloc(dst->num_compatible_brands *
...
void quicktime_read_ftyp(quicktime_t *file, quicktime_ftyp_t *ftyp,
  ...
  ftyp->num_compatible_brands = int((parent_atom->end - quicktime_position(file))/4);
  ftyp->compatible_brands = (uint32_t*)malloc(ftyp->num_compatible_brands *
