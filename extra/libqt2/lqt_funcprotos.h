...
int quicktime_atom_write_header64(quicktime_t *file, quicktime_atom_t *atom, const char *text);
int quicktime_atom_write_header(quicktime_t *file, quicktime_atom_t *atom, const char *text);
void quicktime_atom_write_footer(quicktime_t *file, quicktime_atom_t *atom);
int quicktime_atom_is(quicktime_atom_t *atom, const char *type);
...
void quicktime_update_ctts(quicktime_ctts_t *ctts, int sample, int duration);
...
void quicktime_finalize_moov(quicktime_t *file, quicktime_moov_t *moov, int64_t suggestduration);
...
int quicktime_qtatom_write_header(quicktime_t *file, quicktime_qtatom_t *atom, const char *text, int ID);
void quicktime_qtatom_write_footer(quicktime_t *file, quicktime_qtatom_t *atom);
int quicktime_qtatom_is(quicktime_qtatom_t *atom, const char *type);
...
void quicktime_update_stco(quicktime_stco_t *stco, int chunk, int64_t offset);
...
int quicktime_update_stsc(quicktime_stsc_t *stsc, int chunk, int samples);
...
void quicktime_stps_init(quicktime_stps_t *stss);
void quicktime_stps_delete(quicktime_stps_t *stss);
void quicktime_stps_dump(quicktime_stps_t *stss);
void quicktime_read_stps(quicktime_t *file, quicktime_stps_t *stss);
void quicktime_write_stps(quicktime_t *file, quicktime_stps_t *stss);
...
void quicktime_update_stts(quicktime_stts_t *stts, int sample, int duration);
void quicktime_update_audio_stts(quicktime_stts_t *stts,int sample);
...
LQT_EXTERN int quicktime_chunk_of_sample(int64_t *chunk_sample,int64_t *chunk,int *sd_id,quicktime_trak_t *trak,int64_t sample);
...
int64_t quicktime_sample_to_offset(quicktime_t *file, quicktime_trak_t *trak,int *sd_id,int sample);
...
LQT_EXTERN int quicktime_chunk_samples(quicktime_trak_t *trak, int chunk);
...
LQT_EXTERN int quicktime_match_32(void *input, const void *output);
...
LQT_EXTERN int lqt_chunk_of_sample_vbr(int64_t *chunk_sample,int64_t *chunk,quicktime_trak_t *trak,int64_t sample);
