...
int quicktime_read_ctab(quicktime_t *file, quicktime_ctab_t *ctab)
{
	...
	ctab->alpha = (int16_t*)malloc(sizeof(int16_t) * ctab->size);
	ctab->red = (int16_t*)malloc(sizeof(int16_t) * ctab->size);
	ctab->green = (int16_t*)malloc(sizeof(int16_t) * ctab->size);
	ctab->blue = (int16_t*)malloc(sizeof(int16_t) * ctab->size);
