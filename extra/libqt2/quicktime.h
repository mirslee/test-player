...
int quicktime_write_frame(quicktime_t *file, uint8_t *video_buffer, int64_t bytes,int keyframe,int track);
...
int quicktime_divx_is_key(unsigned char *data, int size);
...
int quicktime_decode_scaled(quicktime_t *file, 
...
int quicktime_decode_audio(quicktime_t *file, int16_t *output_i, float *output_f, int samples, int channel);
...
int quicktime_encode_audio(quicktime_t *file, int16_t **input_i, float **input_f, int samples);
