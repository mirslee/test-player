...
static struct
  ...
  int chs;
  channel_label_t channels[10];
  }
channel_locations[] =
  {
    { CHANNEL_LAYOUT_Mono, 1,{ CHANNEL_LABEL_Center } }, // a standard mono stream

// 2 Channel layouts

    { CHANNEL_LAYOUT_Stereo, 2,{ CHANNEL_LABEL_Left,
                                                   CHANNEL_LABEL_Right } }, // a standard stereo stream (L R)

    { CHANNEL_LAYOUT_StereoHeadphones,2,{ CHANNEL_LABEL_Left,
                                                            CHANNEL_LABEL_Right } }, // a standard stereo stream (L R) - implied headphone playback
    { CHANNEL_LAYOUT_MatrixStereo,2,{ CHANNEL_LABEL_LeftTotal,
                                                        CHANNEL_LABEL_RightTotal } }, // a matrix encoded stereo stream (Lt, Rt)

    { CHANNEL_LAYOUT_MidSide,2,{ CHANNEL_LABEL_MS_Mid,
                                                   CHANNEL_LABEL_MS_Side } }, // mid/side recording

    { CHANNEL_LAYOUT_XY,2,{ CHANNEL_LABEL_XY_X, CHANNEL_LABEL_XY_Y } }, // coincident mic pair (often 2 figure 8's)

    { CHANNEL_LAYOUT_Binaural,2,{ CHANNEL_LABEL_Left,
                                                    CHANNEL_LABEL_Right  } }, // binaural stereo (left, right)

// Symetric arrangements - same distance between speaker locations

    { CHANNEL_LAYOUT_Ambisonic_B_Format,4,{ CHANNEL_LABEL_Ambisonic_W,
                                                              CHANNEL_LABEL_Ambisonic_X,
                                                              CHANNEL_LABEL_Ambisonic_Y,
                                                              CHANNEL_LABEL_Ambisonic_Z } }, // W, X, Y, Z

    { CHANNEL_LAYOUT_Quadraphonic,4,{ CHANNEL_LABEL_Left,
                                                        CHANNEL_LABEL_Right,
                                                        CHANNEL_LABEL_LeftSurround,
                                                        CHANNEL_LABEL_RightSurround } }, // front left, front right, back left, back right

    { CHANNEL_LAYOUT_Pentagonal, 5,{ CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround,
                                                      CHANNEL_LABEL_Center } }, // left, right, rear left, rear right, center

    { CHANNEL_LAYOUT_Hexagonal, 6,{  CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround,
    ...
    { CHANNEL_LAYOUT_Octagonal,8,{ CHANNEL_LABEL_Left,
                                                     CHANNEL_LABEL_Right,
                                                     CHANNEL_LABEL_LeftSurround,
                                                     CHANNEL_LABEL_RightSurround,
                                                     CHANNEL_LABEL_Center,
    ...
    { CHANNEL_LAYOUT_Cube, 8,{ CHANNEL_LABEL_Left,
                                                CHANNEL_LABEL_Right,
                                                CHANNEL_LABEL_LeftSurround,
                                                CHANNEL_LABEL_RightSurround,
...
//  MPEG defined layouts
    ...
    { CHANNEL_LAYOUT_MPEG_3_0_A, 3, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center } },         // L R C

    { CHANNEL_LAYOUT_MPEG_4_0_A, 4, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_CenterSurround } },         // L R C Cs

    { CHANNEL_LAYOUT_MPEG_5_0_A, 5,{ CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround } },         // L R C Ls Rs

    { CHANNEL_LAYOUT_MPEG_5_1_A, 6, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center,
    ...
    { CHANNEL_LAYOUT_MPEG_6_1_A, 7, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_LFEScreen,
                                                      CHANNEL_LABEL_LeftSurround,
    ...
    { CHANNEL_LAYOUT_MPEG_7_1_A, 8, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_LFEScreen,
                                                      CHANNEL_LABEL_LeftSurround,
    ...
    { CHANNEL_LAYOUT_MPEG_5_0_B, 5, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround,
                                                      CHANNEL_LABEL_Center } },         // L R Ls Rs C

    { CHANNEL_LAYOUT_MPEG_5_1_B, 6, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround,
                                                      CHANNEL_LABEL_Center,
    ...
    { CHANNEL_LAYOUT_MPEG_3_0_B, 3,{ CHANNEL_LABEL_Center,
                                                       CHANNEL_LABEL_Left,
                                                       CHANNEL_LABEL_Right } },        // C L R

    { CHANNEL_LAYOUT_MPEG_4_0_B, 4, { CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_CenterSurround } },         // C L R Cs

    { CHANNEL_LAYOUT_MPEG_5_0_D, 5,{ CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround } },         // C L R Ls Rs

    { CHANNEL_LAYOUT_MPEG_5_1_D, 6, { CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround,
    ...
    { CHANNEL_LAYOUT_MPEG_5_0_C, 5, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround } },         // L C R Ls Rs

    { CHANNEL_LAYOUT_MPEG_5_1_C, 6, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_LeftSurround,
                                                      CHANNEL_LABEL_RightSurround,
    ...
    { CHANNEL_LAYOUT_MPEG_7_1_B, 8, { CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_LeftCenter,
    ...
    { CHANNEL_LAYOUT_MPEG_7_1_C, 8, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_LFEScreen,
                                                      CHANNEL_LABEL_LeftSurroundDirect,
    ...
    { CHANNEL_LAYOUT_Emagic_Default_7_1, 8, { CHANNEL_LABEL_Left,
                                                               CHANNEL_LABEL_Right,
                                                               CHANNEL_LABEL_LeftSurround,
                                                               CHANNEL_LABEL_RightSurround,
                                                               CHANNEL_LABEL_Center,
    ...
    { CHANNEL_LAYOUT_SMPTE_DTV, 8, { CHANNEL_LABEL_Left,
                                                      CHANNEL_LABEL_Right,
                                                      CHANNEL_LABEL_Center,
                                                      CHANNEL_LABEL_LFEScreen,
                                                      CHANNEL_LABEL_LeftSurround,
...
//  ITU defined layouts
    ...
    { CHANNEL_LAYOUT_ITU_2_1, 3, { CHANNEL_LABEL_Left,
                                                   CHANNEL_LABEL_Right,
                                                   CHANNEL_LABEL_CenterSurround } },            // L R Cs

    { CHANNEL_LAYOUT_ITU_2_2, 4, { CHANNEL_LABEL_Left,
                                                   CHANNEL_LABEL_Right,
                                                   CHANNEL_LABEL_LeftSurround,
...
// DVD defined layouts
    ...
    { CHANNEL_LAYOUT_DVD_4, 3, { CHANNEL_LABEL_Left,
                                                 CHANNEL_LABEL_Right,
                                                 CHANNEL_LABEL_LFEScreen } },              // L R LFE
    { CHANNEL_LAYOUT_DVD_5, 4, { CHANNEL_LABEL_Left,
                                                 CHANNEL_LABEL_Right,
                                                 CHANNEL_LABEL_LFEScreen,
                                                 CHANNEL_LABEL_CenterSurround } },              // L R LFE Cs
    
    { CHANNEL_LAYOUT_DVD_6, 5, { CHANNEL_LABEL_Left,
                                                  CHANNEL_LABEL_Right,
                                                  CHANNEL_LABEL_LFEScreen,
                                                  CHANNEL_LABEL_LeftSurround,
                                                  CHANNEL_LABEL_RightSurround } },             // L R LFE Ls Rs
    
    { CHANNEL_LAYOUT_DVD_10, 4, { CHANNEL_LABEL_Left,
                                                  CHANNEL_LABEL_Right,
                                                  CHANNEL_LABEL_Center,
                                                  CHANNEL_LABEL_LFEScreen  } },             // L R C LFE
    
    { CHANNEL_LAYOUT_DVD_11,  5, { CHANNEL_LABEL_Left,
                                                   CHANNEL_LABEL_Right,
                                                   CHANNEL_LABEL_Center,
                                                   CHANNEL_LABEL_LFEScreen,
    ...
    { CHANNEL_LAYOUT_DVD_18, 5, { CHANNEL_LABEL_Left,
                                                  CHANNEL_LABEL_Right,
                                                  CHANNEL_LABEL_LeftSurround,
                                                  CHANNEL_LABEL_RightSurround,
    ...
    { CHANNEL_LAYOUT_AudioUnit_6_0, 6, { CHANNEL_LABEL_Left,
                                                         CHANNEL_LABEL_Right,
                                                         CHANNEL_LABEL_LeftSurround,
                                                         CHANNEL_LABEL_RightSurround,
                                                         CHANNEL_LABEL_Center,
    ...
    { CHANNEL_LAYOUT_AudioUnit_7_0, 7, { CHANNEL_LABEL_Left,
                                                         CHANNEL_LABEL_Right,
                                                         CHANNEL_LABEL_LeftSurroundDirect,
                                                         CHANNEL_LABEL_RightSurroundDirect,
                                                         CHANNEL_LABEL_Center,
...
// These layouts are used for AAC Encoding within the MPEG-4 Specification
    ...
    { CHANNEL_LAYOUT_AAC_6_0, 6, { CHANNEL_LABEL_Center,
                                                   CHANNEL_LABEL_Left,
                                                   CHANNEL_LABEL_Right,
                                                   CHANNEL_LABEL_LeftSurround,
                                                   CHANNEL_LABEL_RightSurround,
    ...
    { CHANNEL_LAYOUT_AAC_6_1, 7, { CHANNEL_LABEL_Center,
                                                   CHANNEL_LABEL_Left,
                                                   CHANNEL_LABEL_Right,
                                                   CHANNEL_LABEL_LeftSurround,
                                                   CHANNEL_LABEL_RightSurround,
    ...
    { CHANNEL_LAYOUT_AAC_7_0, 7, { CHANNEL_LABEL_Center,
                                                   CHANNEL_LABEL_Left,
                                                   CHANNEL_LABEL_Right,
                                                   CHANNEL_LABEL_LeftSurroundDirect,
                                                   CHANNEL_LABEL_RightSurroundDirect,
    ...
    { CHANNEL_LAYOUT_AAC_Octagonal, 8, { CHANNEL_LABEL_Center,
                                                         CHANNEL_LABEL_Left,
                                                         CHANNEL_LABEL_Right,
                                                         CHANNEL_LABEL_LeftSurroundDirect,
                                                         CHANNEL_LABEL_RightSurroundDirect,
...
void quicktime_chan_dump(quicktime_chan_t *chan)
  ...
  for(i = 0; i < chan->mNumberChannelDescriptions; i++)
    ...
    lqt_dump("         mChannelLabel[%d]: 0x%08x [%s]\n", i,
           chan->ChannelDescriptions[i].mChannelLabel, get_channel_name((channel_label_t)chan->ChannelDescriptions[i].mChannelLabel));
...
void quicktime_read_chan(quicktime_t *file, quicktime_chan_t *chan)
  ...
  if(chan->mNumberChannelDescriptions)
    {
    chan->ChannelDescriptions = (quicktime_chan_t::chdesc *)calloc(chan->mNumberChannelDescriptions,
...
void quicktime_get_chan(quicktime_audio_map_t * atrack)
  ...
  if(chan->mChannelLayoutTag == CHANNEL_LAYOUT_UseChannelDescriptions)
    {
    atrack->channel_setup = (lqt_channel_t*)calloc(chan->mNumberChannelDescriptions,
                                   sizeof(*atrack->channel_setup));
    atrack->channels = chan->mNumberChannelDescriptions;
    for(i = 0; i < chan->mNumberChannelDescriptions; i++)
      atrack->channel_setup[i] = channel_label_2_channel((channel_label_t)chan->ChannelDescriptions[i].mChannelLabel);
    }
  else if(chan->mChannelLayoutTag == CHANNEL_LAYOUT_UseChannelBitmap)
    {
    /* Count the channels */
    ...
    atrack->channel_setup = (lqt_channel_t*)calloc(num_channels,
                                   sizeof(*atrack->channel_setup));
...
void quicktime_set_chan(quicktime_audio_map_t * atrack)
  ...
  for(int i = 0; i < sizeof(channel_locations) / sizeof(channel_locations[0]); i++)
    {
  ...
  for(int i = 0; i < sizeof(channel_locations) / sizeof(channel_locations[0]); i++)
    ...
    if(((channel_locations[i].layout & 0xffff) == atrack->channels) &&
      ...
      for(int j = 0; j < atrack->channels; j++)
  ...
  chan->ChannelDescriptions =
    (quicktime_chan_t::chdesc *)calloc(atrack->channels, sizeof(*(chan->ChannelDescriptions)));
  chan->mNumberChannelDescriptions = atrack->channels;
  chan->mChannelLayoutTag = CHANNEL_LAYOUT_UseChannelDescriptions;
  for(uint32_t i = 0; i < chan->mNumberChannelDescriptions; i++)
    {
